...
/* package haskell-dither-0.1.0.0 */
#ifndef VERSION_haskell_dither
#define VERSION_haskell_dither "0.1.0.0"
#endif /* VERSION_haskell_dither */
#ifndef MIN_VERSION_haskell_dither
#define MIN_VERSION_haskell_dither(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_dither */
...
#define CURRENT_COMPONENT_ID "haskell-dither-0.1.0.0-inplace-haskell-dither"
